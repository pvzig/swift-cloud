...
public protocol GCPLinkable: Linkable {
    ...
    /// Whether the consuming workload may depend on the access grants without
    /// forming a cycle through this resource.
    var ordersConsumerAfterAccessGrants: Bool { get }
}
...
extension GCPLinkable {
    public var ordersConsumerAfterAccessGrants: Bool {
        true
    }
}
...
extension GCPRoleProvider {
    ...
    public func link(_ linkable: any GCPLinkable) -> Self {
        ...
        if linkable.ordersConsumerAfterAccessGrants {
